...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s positive-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  positive-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded positive transaction") + "\n" +
              "  positive-tx [options] -create [commands]   " + _("Create hex-encoded positive transaction") + "\n" +
              "\n";
