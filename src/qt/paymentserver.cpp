...
const QString BITCOIN_IPC_PREFIX("positive:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/positive-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/positive-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/positive-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start positive: click-to-pay handler"));
        }
        else {
