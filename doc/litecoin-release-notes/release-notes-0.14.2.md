Positive Core version 0.14.2 is now available from:
  ...
  <https://download.positive.org/positive-0.14.2.0/>
...
- http://testnet.positivetools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/positive-project/positive/blob/master/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/positive-project/positive/blob/master/doc/zmq.md) for
...
Commands sent over the JSON-RPC interface and through the `positive-cli` binary
can now use named arguments. This follows the [JSON-RPC specification](http://www.jsonrpc.org/specification)
for passing parameters by-name with an object.

`positive-cli` has been updated to support this by parsing `name=value` arguments
when the `-named` option is given.

Some examples:

    src/positive-cli -named help command="help"
    src/positive-cli -named getblockhash height=0
    src/positive-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
    src/positive-cli -named sendtoaddress address="(snip)" amount="1.0" subtractfeefromamount=true
