Positive Core version *0.15.1* is now available from:
  ...
  <https://download.positive.org/positive-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 protons per kB (0.00001 PSTV). This is to prepare for dropping the minimum transaction fee to 0.1 protons per kB (0.0001 PSTV) in the next release.
