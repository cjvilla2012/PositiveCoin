...
* positive.conf: contains configuration settings for positived or positive-qt
* positived.pid: stores the process id of positived while running
...
* debug.log: contains debug information and general logging generated by positived or positive-qt
